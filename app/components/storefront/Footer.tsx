...
interface StoreSettings {
  general: {
    ...
    company_description: { value: string }
  }
  contact: {
    contact_address: { value: string }
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        setSettings({
          general: {
            company_name: { value: 'CV. Aprinia Geosat Solusindo' },
            company_description: { value: 'CV. Aprinia Geosat Solusindo provides professional survey equipment, GPS tools, and mapping solutions for all your geospatial needs.' }
          },
          contact: {
            contact_address: { value: 'Jl. Raya Pasar Minggu No.123, Jakarta Selatan, Indonesia' },
            contact_phone: { value: '(+62) 21-1234-5678' },
            contact_email: { value: 'info@apriniageosat.co.id' },
            business_hours: { value: 'Mon-Fri: 8:00 AM - 5:00 PM' }
          },
          social: {
            facebook_url: { value: '#' },
            instagram_url: { value: '#' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/shipping-policy" className="text-gray-400 hover:text-white">
                  Shipping Policy
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/terms-conditions" className="text-gray-400 hover:text-white">
                  Terms & Conditions
                </a>
              </li>
            </ul>
